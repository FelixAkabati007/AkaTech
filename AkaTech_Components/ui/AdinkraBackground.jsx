...
const AdinkraBackground = () => {
  ...
  return (
    <div
      className="fixed inset-0 z-0 pointer-events-none overflow-hidden select-none dark:hidden"
      aria-hidden="true"
    >
      {symbols.map((s) => (
        <svg
          ...
          className="text-akatech-gold/10 fill-current transition-all duration-500 ease-in-out"
        >
