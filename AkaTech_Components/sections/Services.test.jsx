...
vi.mock('@lib/data', () => ({
  SERVICES: [
    { title: 'Service 1', desc: 'Description 1', icon: (props) => <div data-testid="icon-service-1" {...props} /> },
    { title: 'Service 2', desc: 'Description 2', icon: (props) => <div data-testid="icon-service-2" {...props} /> },
  ],
}));
