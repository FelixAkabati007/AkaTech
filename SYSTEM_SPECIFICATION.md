...
| **Project Mgmt**        | Full lifecycle project control. | • CRUD Projects via Modal.<br>• Client Assignment.<br>• Status & Phase updates.<br>• Internal vs. Client notes.                   | Admin/Manager | All project data.       |
...
| **Messages & Support**  | Centralized communication.      | • Inbox for inquiries/messages.<br>• Filter (All/Unread/Read).<br>• Email reply integration.<br>• Mark as Read/Delete.            | Admin/Support | All messages & tickets. |
...
- **Projects:**
  - Admins can move projects between phases: _Initiation → Design → Development → Deployment → Maintenance_.
  - Clients can only view current phase and status (_In Progress, Completed, Pending_).
- **Invoicing:**
...
- **Messages:**
  - Admins can view incoming messages from the contact form or direct inquiries.
  - Filtering options: All, Unread, Read.
  - "Reply via Email" opens the default mail client with pre-filled recipient.
  - Messages can be deleted or marked as read/unread.
...
4.  Click **Create**.
5.  _System:_ Creates project, notifies client, logs activity.
...
6.  _System:_ Generates PDF, emails client, updates dashboard stats.
...
6.  _System:_ Updates status to "Resolved", notifies client.

### 5.4 Managing Messages (Admin)

1.  Navigate to **Messages**.
2.  Filter by **Unread** to see new inquiries.
3.  Select a message to view details (Sender, Subject, Content).
4.  Click **Reply via Email** to initiate response.
5.  _System:_ Opens external mail client.
6.  Admin manually marks message as **Read** or **Deletes** it after handling.
...
### 12.1 Creating a New Project (Admin)

To create a new project in the Admin Portal:

1.  Click on the **Projects** tab in the sidebar.
2.  Click the **New Project** button in the top right.
3.  Fill in the required fields:
    - **Project Title**: e.g., "Corporate Website Redesign"
...
4.  Click **Create Project**. The new project will appear in the list immediately.

### 12.2 Managing Messages (Admin)

To handle incoming inquiries:

1.  Navigate to the **Messages** tab.
2.  Use the **Filter** buttons (All, Unread, Read) to organize the view.
3.  Click on a message row to view the full content.
4.  Use the **Reply via Email** button to open your default email client with the subject and recipient pre-filled.
5.  Once resolved, click the **Delete** icon or ensure the message is marked as Read.
